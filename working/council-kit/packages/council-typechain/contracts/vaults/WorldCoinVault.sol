...
abstract contract AbstractWorldCoinVault is IVotingVault{
    ...
    mapping(address => bool) internal userVerified;
...
contract WorldCoinVault is AbstractWorldCoinVault {
    /// @notice Constructs the contract by setting immutables
    /// @param _worldId The WorldID instance that will verify the proofs
	/// @param _appId The World ID app ID
	/// @param _actionId The World ID action ID
    constructor(IWorldID _worldId, string memory _appId, string memory _actionId)
        AbstractWorldCoinVault(_worldId,_appId,_actionId)
    {}
}